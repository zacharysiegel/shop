...
impl ShopModel for ItemAuditModel {
    ...
    fn try_from_entity(entity: &Self::Entity) -> Result<Self, ShopError> {
        Ok(ItemAuditModel {
            ...
            status_before: ItemStatus::try_from_int_with_shoperror(entity.status_before as u8)?,
            status_after: ItemStatus::try_from_int_with_shoperror(entity.status_after as u8)?,
